...
public class Heap {
	...
	public Heap(int size) {
		this.maxSize = size;
		currentSize = 0;
		heapArray = new Node[size]; // actually creates the array of proper size
	}
	...
	private void trickleUp(int idx) {
		...
		// loop as long as we haven't reached the root of the heap and key of
		// nodeToInsert's parent is less than newNode
	...
	private void trickleDown(int idx) {
		...
		// will run as long as idx is not on the bottom row (atleast 1 child)
